...
namespace Rsvfx
{
    ...
    sealed class DepthConverter : System.IDisposable
    {
        ...
        public void UpdateAttributeMaps (Eidetic.URack.PointCloud pointCloud)
        {
            ...
            pointCloud.SetPositionMap(_tempPositionMap);
            pointCloud.SetColorMap(_tempColorMap);
        ...
        void BakeToTempMaps()
        {
            ...
            if (_tempColorMap == null)
            {
                _tempColorMap = new RenderTexture(
                    _dimensions.x, _dimensions.y, 24, R32G32B32A32_SFloat);
